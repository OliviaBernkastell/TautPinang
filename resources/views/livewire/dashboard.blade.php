<div>
    ...
    <div class="relative py-12">
        ...
        <div class="relative z-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <!-- Welcome Section -->
            <div class="p-6 mb-6 overflow-hidden text-center shadow-xl bg-white/80 backdrop-blur sm:rounded-lg welcome-card">
                <!-- Logo di tengah -->
                <div class="mb-4">
                ...
                <p id="tp-text" class="mb-1 text-lg text-gray-700 translate-y-2 opacity-0">
                    Selamat datang di <strong>Taut Pinang</strong>, pembuat tautan dari
                    <span class="font-semibold">BPS Kota Tanjungpinang</span>.
                </p>
                ...
                <div id="quick-actions" class="flex flex-wrap justify-center gap-3 mt-6 opacity-0">
                    <a href="{{ route('buat-tautan') }}" wire:navigate
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 via-green-600 to-orange-600 border border-transparent rounded-md shadow-sm hover:from-blue-700 hover:via-green-700 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transform transition-all duration-200 hover:scale-105">
                    ...
                    <a href="{{ route('kelola-tautan') }}" wire:navigate
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-md shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transform transition-all duration-200 hover:scale-105">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="stats-section" class="grid grid-cols-1 gap-6 mb-6 stats-grid sm:grid-cols-2 lg:grid-cols-4">
                <!-- Total Tautans -->
                <div class="stat-card p-6 bg-white/90 backdrop-blur shadow-lg rounded-xl">
            ...
            @if($recentTautans->count() > 0)
                <div id="recent-section" class="p-6 bg-white/90 backdrop-blur shadow-lg rounded-xl">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0">
                                        @if($tautan->logo_url)
                                            <img class="w-10 h-10 rounded-lg object-cover" src="{{ $tautan->logo_url }}" alt="Logo">
                                        @else
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">/{{ $tautan->slug }} • {{ $tautan->links_count }} links</p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full {{ $tautan->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                        {{ $tautan->is_active ? 'Aktif' : 'Nonaktif' }}
                                    </span>
                                    <a href="{{ route('tautan.show', $tautan->slug) }}" target="_blank"
                                        class="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400" title="Kunjungi">
            ...
            @else
                <!-- Empty State -->
                <div id="empty-state" class="p-12 text-center bg-white/90 backdrop-blur shadow-lg rounded-xl">
                    <div class="flex flex-col items-center">
                        ...
                        <a href="{{ route('buat-tautan') }}" wire:navigate
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 via-green-600 to-orange-600 border border-transparent rounded-md shadow-sm hover:from-blue-700 hover:via-green-700 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                            Buat Tautan Baru
